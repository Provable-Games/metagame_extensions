...
fn test_happy_path_valid_proof() {
    ...
    let result = entry_validator.valid_entry(OWNER_ADDRESS(), TOURNAMENT_ID, PLAYER_ADDRESS(), qualification_span());
...
fn test_config_extended_elements() {
    ...
    assert!(
        zkp_validator.get_expected_param_commitment(OWNER_ADDRESS(), TOURNAMENT_ID) == PARAM_COMMITMENT,
...
fn test_entries_left_tracking() {
    ...
    let left = entry_validator.entries_left(OWNER_ADDRESS(), TOURNAMENT_ID, PLAYER_ADDRESS(), qualification_span());
    ...
    entry_validator.add_entry(TOURNAMENT_ID, 1, PLAYER_ADDRESS(), qualification_span());
    let left2 = entry_validator.entries_left(OWNER_ADDRESS(), TOURNAMENT_ID, PLAYER_ADDRESS(), qualification_span());
    ...
    entry_validator.remove_entry(TOURNAMENT_ID, 1, PLAYER_ADDRESS(), qualification_span());
    let left3 = entry_validator.entries_left(OWNER_ADDRESS(), TOURNAMENT_ID, PLAYER_ADDRESS(), qualification_span());
