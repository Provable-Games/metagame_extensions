...
pub mod TournamentValidator {
    ...
    use interfaces::registration::{IRegistrationDispatcher, IRegistrationDispatcherTrait};
    use interfaces::tournament::{ITournamentDispatcher, ITournamentDispatcherTrait, Phase};
