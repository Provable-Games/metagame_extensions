...
if [ ! -f "target/dev/entry_requirement_extensions_OpusTrovesValidator.contract_class.json" ]; then
    print_error "OpusTrovesValidator contract build failed or contract file not found"
    print_error "Expected: target/dev/entry_requirement_extensions_OpusTrovesValidator.contract_class.json"
